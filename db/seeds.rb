...
# a1 = Author.create!(name: "Billy Bob", genre: "sci", bio: "awesome")
# a2 = Author.create!(name: "Bob Bob", genre: "stuff", bio: "nah")
# a3 = Author.create!(name: "Billy Billy", genre: "trees", bio: "lol")
